...
{
    public class StartData : DropCreateDatabaseAlways<UserContext>
    {
        protected override void Seed(UserContext db)
        {
            ...
            //db.DoctorSpecialties.Add(new DoctorSpecialty { Id = 2, Name = "DERMATOLOGY", NumberRoom = 02 });
            //db.DoctorSpecialties.Add(new DoctorSpecialty { Id = 3, Name = "FAMILY MEDICINE", NumberRoom = 03 });
            //db.DoctorSpecialties.Add(new DoctorSpecialty { Id = 4, Name = "NEUROLOGY", NumberRoom = 04 });
            // db.DoctorSpecialties.Add(new DoctorSpecialty {Id=5, Name = "GYNECOLOGY" });
            // db.DoctorSpecialties.Add(new DoctorSpecialty {Id=6, Name = "OPHTHALMOLOGY" });
            // db.DoctorSpecialties.Add(new DoctorSpecialty {Id=7, Name = "PATHOLOGY" });
            // db.DoctorSpecialties.Add(new DoctorSpecialty { Name = "PEDIATRICS" });
            // db.DoctorSpecialties.Add(new DoctorSpecialty { Name = "PSYCHIATRY" });
            //db.DoctorSpecialties.Add(new DoctorSpecialty { Name = "UROLOGY" });
            //db.DoctorSpecialties.Add(new DoctorSpecialty { Name = "SURGEON" });
